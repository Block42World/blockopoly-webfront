...
BLOCK.pushVertices = function( vertices, world, lightmap, x, y, z )
{
	...
	if(block.isColorful)
	{
		...
		if ( z == world.sz - 1 || world.blocks[x][y][z+1].transparent || block.fluid )
		{
			...
			pushQuad(
				vertices,
				[ x, y, z + bH, c[0], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y, z + bH, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z + bH, c[2], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x, y + 1.0, z + bH, c[0], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ]
			);
		}
		...
		if ( z == 0 || world.blocks[x][y][z-1].transparent )
		{
			...
			pushQuad(
				vertices,							
				[ x, y + 1.0, z, c[0], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z, c[2], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y, z, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
		...
		if ( y == 0 || world.blocks[x][y-1][z].transparent )
		{
			...
			pushQuad(
				...
				[ x + 1.0, y, z, c[2], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y, z + bH, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x, y, z + bH, c[0], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ]
			);
		}
		...
		if ( y == world.sy - 1 || world.blocks[x][y+1][z].transparent )
		{
			...
			pushQuad(
				vertices,
				[ x, y + 1.0, z + bH, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z + bH, c[0], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z, c[0], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x, y + 1.0, z, c[2], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ]
			);
		}
		...
		if ( x == 0 || world.blocks[x-1][y][z].transparent )
		{
			...
			pushQuad(
				vertices,
				[ x, y, z + bH, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x, y + 1.0, z + bH, c[0], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x, y + 1.0, z, c[0], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
		...
		if ( x == world.sx - 1 || world.blocks[x+1][y][z].transparent )
		{
			...
			pushQuad(
				vertices,
				[ x + 1.0, y, z, c[0], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z, c[2], c[3], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y + 1.0, z + bH, c[2], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ],
				[ x + 1.0, y, z + bH, c[0], c[1], r*lightMultiplier, g*lightMultiplier, b*lightMultiplier, 1.0 ]
			);
		}
	}
	else{
